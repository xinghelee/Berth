...
- [~] M3 — 高级连接(分支 `feat/m3-advanced`,未合并):已完成——跳板机链式、端口转发(本地/动态 SOCKS5 已真机验证;远程转发监听通、数据路径待修)、HTTP/SOCKS5 代理(已验证)、服务器信息 inspector(⌘I)、JSON 备份。**剩余**:ssh-agent 认证、remote 转发数据路径、M3 验收合并
